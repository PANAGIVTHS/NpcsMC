...
# Run pathfind
$execute as @s function npc:internal/_pathfind_basic {id:$(id)}

# Check completion
$execute if entity @e[tag=reached_$(id)] run execute as @s function npc:internal/_task_complete {id:$(id)}